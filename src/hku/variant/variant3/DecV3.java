...
//	private CCSSaver saver = null;
	...
	public DecV3(int graph[][], String nodes[][], TNode root, int core[]) {
		this.graph = graph;
		this.nodes = nodes;
		this.root = root;
		this.core = core;
	...
	public List<Set<Integer>> query(int queryId, String inKws[]){
...
//		this.startT = System.currentTimeMillis();
		...
		for(int nghId:graph[queryId])   if(core[nghId] >= Config.k)   nghList.add(nghId);
...
//				System.out.println("we have found " + ccsList.size() + " ccs communities:" + (System.currentTimeMillis() - startT));
				break;
			}
		}
		return ccsList;
